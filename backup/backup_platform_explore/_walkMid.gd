...
#		print("Debug - _walkMid.gd : Go to Idle")
		return stateIdle
		
	elif regionWalkSlow.has_point(input_vector):
#		print("Debug - _walkMid.gd : Go to walkSlow")
		return stateWalkSlow
		
	elif regionWalkMid.has_point(input_vector):
#		print("Debug - _walkMid.gd : Stay in Walk Slow")
		pass
		
	elif regionWalkFast.has_point(input_vector):
#		print("Debug - _walkMid.gd : Go to walkFast")
		return stateWalkFast
		
	elif regionJump.has_point(input_vector):
		print("Debug - _walkMid.gd : Go to Jump")
		
	elif regionTiltTurn.has_point(input_vector):
		print("Debug - _walkMid.gd : Go to Tilt Turn")
		return stateTiltTurn
		
	else:
		print("Debug - _walkMid.gd : None of the above")
