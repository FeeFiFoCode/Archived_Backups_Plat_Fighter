...
#		print("Debug - _walkFast.gd : Go to Idle")
		return stateIdle
		
	elif regionWalkSlow.has_point(input_vector):
#		print("Debug - _walkFast.gd : Go to walkSlow")
		return stateWalkSlow

	elif regionWalkMid.has_point(input_vector):
#		print("Debug - _walkFast.gd : Go to Walk Slow")
		return stateWalkMid
		
	elif regionWalkFast.has_point(input_vector):
#		print("Debug - _walkFast.gd : Stay in Walk Fast")
		pass
		
	elif regionJump.has_point(input_vector):
		print("Debug - _walkFast.gd : Go to Jump")
		pass
		
	elif regionTiltTurn.has_point(input_vector):
		print("Debug - _walkFast.gd : Go to Tilt Turn")
		return stateTiltTurn
		
	else:
#		print("Debug - _walkFast.gd : None of the above")
		pass
